...
Netatalk ist im Beta-Test. Bitte Probleme und Anregungen im "Bugtracker Github Issues":https://github.com/svoop/freetz-netatalk/issues erfassen, zuerst aber unbedingt "Bekannte Einschränkungen" weiter unten lesen!
...
Eine weitere Nebenwirkung ist, dass alle Änderungen am Filesystem via AFP geschehen müssen, d.h. auf ein Share darf nicht gleichzeitig mit AFP und anderen Methoden (SMB, SFTP etc) geschrieben werden, denn nur AFP aktualisiert die CNID Datenbank. Wird z.B. mit SMB eine neue Datei erstellt, ist sie für AFP nicht sichtbar. Künftige Versionen von Netatalk werden möglicherweise einen Filesystem-Crawler beinhalten.
